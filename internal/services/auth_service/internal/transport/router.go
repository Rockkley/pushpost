...
import (
	...
	myMW "github.com/rockkley/pushpost/internal/services/auth_service/internal/transport/http/middleware"
	"github.com/rockkley/pushpost/pkg/logger"
	"net/http"
)

func NewRouter(authMW *myMW.AuthMiddleware, authHandler *myHTTP.AuthHandler) *chi.Mux {
	r := chi.NewRouter()
